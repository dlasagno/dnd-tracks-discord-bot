...
module.exports = class ListCommand extends discord_js_commando_1.Command {
    constructor(client) {
        super(client, {
            name: "list",
            aliases: ["ls"],
    ...
    run(message, { trackName }) {
        return __awaiter(this, void 0, void 0, function* () {
            const trackUrls = tracksManager.getUrls();
            if (trackName in trackUrls) {
                message.embed(messageFormatter
                    .getBaseMessage()
                    .addField(`Tracks for ${trackName}`, (yield Promise.all(trackUrls[trackName].map((url, i) => __awaiter(this, void 0, void 0, function* () { return `${i} - ${yield utils_1.getTrackTitle(url)}`; })))).join("\n")));
            }
            else {
                message.embed(messageFormatter.getBaseMessage().addField("List of tracks", `\n${Object.entries(tracksManager.getUrls())
